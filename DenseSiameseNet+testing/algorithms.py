...
class ALGO(object):
    ...
    def process_lfda(self, **option):
        ...
        self.Trans['LFDA'] = lfda.transformer().T
    ...
    def run_processes(self):
        ...
        for method in self.Trans:
            L = self.Trans[method]
            self.Dist[method] = pairwise_distances(self.GeneExp.dot(L))
